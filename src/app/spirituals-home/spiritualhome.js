  ...
  const religions = [
    {
      ...
      name: 'HINDUISM',
      color: '#e65100',
      image: '/assets/images/hinduism.png'
    },
    {
      id: 'sikhism',
      name: 'SIKHISM',
      color: '#146073',
      image: '/assets/images/sikhism.png'
    },
    {
      id: 'islam',
      name: 'ISLAM',
    ...
    },
    {
      ...
      name: 'BUDDHISM',
      color: '#8e24aa',
      image: '/assets/images/budhuism.png'
    },
    {
      id: 'christianity',
      name: 'CHRISTIANITY',
      color: '#b71c1c',
      image: '/assets/images/chirstianity.png'
    },
    {
      id: 'jainism',
      name: 'JAINISM',
      color: '#5d4037',
      image: '/assets/images/jainism.png'
    }
  ];
    ...
    <>
      ...
      <main className="religion-selection-page">
        <div className="container pt-5">
          <h1 className="text-center mb-5 fw-bold"><strong>CHOOSE YOUR PRACTISE RELIGION</strong></h1>
                ...
                >
                  <div className="position-relative w-100 h-100">
                    <Image
                      ...
                      alt={religion.name}
                      fill
                      style={{ objectFit: 'contain',bottom:'-30px',top:'inherit' }}
                      priority
                    />
          ...
          <div className="row justify-content-center">
            {religions.slice(3).map((religion,index) => (
              <div key={religion.id} className="col-md-4 col-sm-6 mb-4">
                <div 
                  className="religion-card"
                  style={{ backgroundColor: religion.color }}
                ...
                >
                  <div className="position-relative w-100 h-100">
                    <Image
                      ...
                      style={{ objectFit: 'contain',bottom:index>2&&'-50px',top:'inherit',bottom:'-50px'}}
                      priority
                    />
                    <div className="religion-name">
                      {religion.name}
