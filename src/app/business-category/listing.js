          ...
          <div className="col-12">
            <nav aria-label="breadcrumb">
              <ol className="breadcrumb">
                ...
                <li className="breadcrumb-item ps-1 active" aria-current="page">
          ...
          <div className="col-md-6 col-lg-5">
            ...
            <div className="card mb-4">
              <div className="card-body rounded-0">
                <h5 className="card-title mb-1">Buy Request for</h5>
                <p className="mb-0 text-secondary">Construction & Decoration</p>
                ...
                <form onSubmit={handleSubmit} noValidate>
                  ...
                  <div className="mb-3">
                    <input 
                      type="text" 
                      className={`form-control fw-light rounded-0 ${formErrors.name ? 'is-invalid' : ''}`}
                      placeholder="Name*"
                      name="name"
                      value={formData.name}
                  ...
                  <div className="mb-3">
                    <input 
                      type="tel" 
                      className={`form-control fw-light rounded-0 ${formErrors.mobile ? 'is-invalid' : ''}`}
                  ...
                  <div className="mb-3">
                    <input 
                      type="text" 
                      className={`form-control fw-light rounded-0 ${formErrors.city ? 'is-invalid' : ''}`}
                      placeholder="City*"
                      name="city"
                      value={formData.city}
                      onChange={handleChange}
                  ...
                  <button type="submit" className="btn rounded-0 w-100 py-2 " style={{background: '#e74c3c'}}>
            ...
            <div className="card companies_card">
